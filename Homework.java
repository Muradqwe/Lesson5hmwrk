...
import Lesson5.MultithreadingExample;
...
public class Homework {
    ...
    private static long multiThread(float[] arr) {
        ...
        MultithreadingExample.MyThread t1 = new MultithreadingExample.MyThread("a", a);
        MultithreadingExample.MyThread t2 = new MultithreadingExample.MyThread("b", b);
